...
MapScene:
    ...
    - display city names (ugly atm)
    - better city names, nbot the same name 3 times
...
DriveScene:
    ...
    - wind looks ugly
    - slowest speed with s also increases when speed increases, make s-speed constant
    - display city your going to
